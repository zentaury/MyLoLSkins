        ...
        <div>
            <div className="text-center">
                ...
                <div className="h-32 w-full mb-5">
                    <AdBanner key={1} data-ad-slot={`${process.env.NEXT_PUBLIC_GOOGLE_ADSENSE_SLOT_DISPLAY1_HOME}`} data-full-width-responsive="true" data-ad-layout="in-article" data-ad-format="fluid"/>
                </div>
            </div>
